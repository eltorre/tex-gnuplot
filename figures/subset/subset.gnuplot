...
set xlabel "Correct entries"

plot	'unlp-nuig-nmt-4cycle_trans_en-fr.tsv.out.t' u 2:3 w l ls 4 t '' ,\
		'unlp-nuig-nmt-4cycle_trans_en-fr.tsv.out.t.dis' u 1:2 w p ls 4 t '' 
